/**
*┌──────────────────────────────────────────────────────────────┐
*│　描   述：SocketAsyncEventArgs socket异步通信client 端                                                    
*│　作   者：zhx                                             
*│　版   本：1.0                                                 
*│　创建时间：2019/2/15 9:27:54                             
*└──────────────────────────────────────────────────────────────┘
**/
...
namespace Client
{
    ...
    class TcpClient : IDisposable
    {
        ...
        internal TcpClient(String ip, Int32 port)
        {
    ...
    class Request
    {
        ...
        public static SocketError Connect(string ip,int port)
        {
            ...
            //创建连接对象, 连接到服务器  
            smanager = new TcpClient(ip, port);
        ...
        public static void StartHeartbeat()
        {
            ...
            heartTimer.Interval = 1000; //每30秒执行一次  
